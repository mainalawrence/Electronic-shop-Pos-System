            ...
            Row{
                ...
                Button{
                    ...
                    onClicked: {
                        ...
                        masterController.onAdd_items(nametxt.text,categorytxt.text,Number(quantitytxt.text),Number(pricetxt.text),Number(wholesale.text),Number(maxdiscounttxt.text));
                        nametxt.text=""
                        quantitytxt.text=""
                        pricetxt.text=""
