  ...
  Rectangle{
      ...
      Row{
         ...
         Button{
             ...
             onClicked: {
                masterController.onPush_employee(fnametxt.text,gender.currentText,lnametxt.text,role.currentIndex,emailtxt.text,usernametxt.text, passnametxt.text,phonetxt.text)
